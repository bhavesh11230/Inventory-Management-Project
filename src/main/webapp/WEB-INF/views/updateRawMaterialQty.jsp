...
<body>
    ...
    <div class="main-content">
        <div class="content">
            ...
            <h1>Enter Details</h1>
                <form action="updateRawQuantity" method="post">
                    <label for="email">Enter Material ID :</label>
                    <input type="text" id="rid" name="rid" placeholder="Enter Material ID">
                    <label for="password">Enter Updated Quantity :</label>
                    <input type="number" id="rqty" name="rqty" placeholder="Enter Quantity">
